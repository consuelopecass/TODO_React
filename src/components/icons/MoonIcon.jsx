const MoonIcon = ({ fill = "#fff", ...props }) => {
    ...
    que almacena el resto de propiedades del objeto  ()*/
    return (
        <svg
            {...props}
            /* el ...props que le estoy pasando es spread operator, es 
            el rest operator de arriba pero lo desarmo y lo meto acá*/
            fill={fill}
